...
$(document).ready(function () {
  // line
  var target = document.querySelector(".line");
  var links = document.querySelectorAll(".nav-list__link_main");
  ...
  function mouseenterFunc() {
    ...
    var width = this.getBoundingClientRect().width; // const height = this.getBoundingClientRect().height;

    var left = this.getBoundingClientRect().left; // const top = this.getBoundingClientRect().top;

    target.style.width = "".concat(width, "px"); // target.style.height = `${height}px`;

    target.style.left = "".concat(left, "px"); // target.style.top = `${top}px`;
  ...
  new ScrollMagic.Scene({
    ...
    offset: "330",
    duration: ""
  }).setClassToggle("#header", "active").addTo(controller);
  var controller2 = new ScrollMagic.Controller();
  var tween2 = TweenMax.to("#cloud", 0.5, {
    left: "100%",
    top: "500px",
  ...
  var tween3 = TweenMax.to("#cloud2", 0.5, {
    right: "100%",
    bottom: "-50px",
    ease: Linear.easeNone
  });
  new ScrollMagic.Scene({
    ...
    duration: 900,
    offset: 300
  }).setTween(tween3) // .addIndicators({name: "cloud"})
  .addTo(controller3); //
