...
/******/ 	deferredModules.push(["./src/js/import/pages/detail.js","vendor"]);
...
$(document).ready(function () {
  var navImg = document.querySelectorAll('.small img');
  var bigImg = document.querySelector('.big img');

  for (var i = 0; i < navImg.length; i++) {
    navImg[i].addEventListener('click', toggleSource);
  }

  function toggleSource(e) {
    var currentPath = e.target.getAttribute('src');
    bigImg.setAttribute('src', currentPath);
  } //
  ...
  for (var _i2 = 0; _i2 < selectArr.length; _i2++) {
    var select = new Select(selectArr[_i2]);
    select.init();
  }
